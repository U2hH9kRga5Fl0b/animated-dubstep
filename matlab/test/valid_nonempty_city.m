...
% 1->3 + 3->2 + 2->1 
%   8  +  10  +  6   
%assert(times(1) == 24, 'This was the wrong amount of distance for the first driver.');
%assert(times(2) ==  0, 'This was the wrong amount of distance for the second driver.');
